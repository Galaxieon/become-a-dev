var browserCheck = () => {
    ...
    //     " Recommened Browsers" +
    //     "<ul>" +
    //     "<li>Chrome 85 or Above in Windows</li>" +
    //     "<li>Chrome 80 or Above in Android" +
    ...
    //     message();
    // } else if (browser.includes("Chrome/81")) {
    //     message();
    // } else if (browser.includes("Chrome/82")) {
    //     message();
    // } else if (browser.includes("Chrome/83")) {
    //     message();
    // } else if (browser.includes("Chrome/84")) {
    //     message();
